        ...
        <nav>
          <span className="burger-icon">
            ...
            <ul>
              ...
              <li ref={Prop}>
                {" "}
                <Link to="/PropertiesPage">Properties</Link>
              </li>
              <li ref={details}>
                {" "}
          ...
          <ul>
            <li onClick={clickHome}>
              {" "}
              <Link ref={Home} to="/" id="activelink">
                Home
              </Link>
            </li>
            <li onClick={clickProp}>
              {" "}
              <Link ref={Prop} to="/PropertiesPage">
                Properties
              </Link>
            </li>
            <li onClick={clickDetails}>
              {" "}
              <Link ref={details} to="/Details">
                Property Details
              </Link>
            </li>
            <li onClick={clickContact}>
              {" "}
              <Link ref={contact} to="/ContactUsPage">
                Contact Us
              </Link>
            </li>
            <li>
